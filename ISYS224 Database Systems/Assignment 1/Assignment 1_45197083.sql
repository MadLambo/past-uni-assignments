...
DROP TABLE IF EXISTS `supervisor`,`staff`,`client`, `campaign`, `studio`, `advert`, `invoice`, `staff_works_campaign`;
...
(10000013, 'Oliver', 'Lookman', 'Male', '1974-09-28', 'oliver.lookman@shine.com.au', 0437895632, 'Technical Personnel', 'Full Time', NULL),	
...
('C01', 'Pixel Arts Inc.', '0251561802', 'admin@pixelarts.com.au', '91 Moores Drive Sydney 2000', 10000017),
('C02', 'Romeo Chemist', '0259803838', 'exec@romeochemist.com.au', '72 Edmundson Road Parramatta 2150', 10000002),
('C03', 'ABC Driving School', '0282582766', 'contact@abcdriving.com.au', '69 Decca Road Lindfield 2070', 10000004),
('C04', 'Rando’s Chicken', '0233349318', 'admin@randochicken.com.au', '45 Cunningham Street Cronulla 2230', 10000012),
...
('C07', 'Australian Post', '0263981701', 'help@australianpost.com.au', '8 Rupara Street Chatswood 2067', 10000002);
...
#Question 5
select distinct staff_firstname, staff_lastname
from staff s, campaign c, staff_works_campaign w
where s.staffid = w.StaffID
and s.staff_status = 'FUll TIme'
and s.staff_position != 'Manager';
